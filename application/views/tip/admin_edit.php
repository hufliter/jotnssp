...
?><div class="row-fluid">
	...
	echo form_hidden('id',$tip->id);
		?><div class="control-group">
			<label class="control-label" for="name">Tên</label>
			<div class="controls"><?php
				echo form_input(array(
					'name'=>'name','value'=>$tip->name,
			...
			<div class="controls"><?php
				echo form_reset(array(
					...
					'name'=>'submit','value'=>'Sửa bí kíp','class'=>'btn btn-info'
				));
			?></div>
		</div><?php
	echo form_close();
