...
?><div class="row-fluid">
	<div class="span12 round" style="position:relative">
		<ul class="breadcrumb well well-small">
			...
			echo anchor('/admincp/news/add/','Thêm tin tức','class="btn btn-info addBtn"');
		?></div>
	</div>
	...
	<table class="table table-hover table-striped">
		<thead><tr>
			...
			?><tr><td colspan="5">Không có tin tức nào</td></tr><?php
			endif;
		?></tbody><tfoot>
			<tr><td colspan="5"><?php
...
(function(){
	...
	$('.addBtn').click(function(){
		actionForm(this,'Thêm tin tức');
		return false;
	});

	$('.deleteBtn').click(function(){
		if(confirm('Are you sure'))
			actionForm(this,'Xóa tin tức');
		return false;
	});

	$('.editBtn').click(function(){
		actionForm(this,'Sửa tin tức');
		return false;
	});
})(jQuery);
</script>