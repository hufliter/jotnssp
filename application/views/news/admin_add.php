		...
		?><div class="control-group">
			...
			<div class="controls"><?php
				echo form_input(array(
					...
					'placeholder'=>'Tên tin tức','id'=>'name',
					'autocomplete' => 'off'
				));
			...
			Chi tiết <?php
				$detail = stripslashes(html_entity_decode($this->input->get_news_detail(), ENT_QUOTES));
				if(empty($detail))
					$detail = null;
				echo form_textarea(array(
			...
			<div class="controls"><?php
				echo form_reset(array(
					...
					'name'=>'submit','value'=>'Thêm tin tức','class'=>'btn btn-info'
				));
			?></div>
		</div><?php
	echo form_close();
